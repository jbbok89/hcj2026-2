...
//getFullyear(), toDateString(), toLocaleString()
...
function showhtml() {
    ...
    document.getElementById('desc').innerHTML = 'HTML은 웹문서를 작성하는데 사용하는 마크업 언어이다.'
}
function showcss() {
    document.getElementById('fig').src = 'img/css.png'
    document.getElementById('desc').innerHTML = 'CSS는 웹문서의 스타일을 지정하는데 사용하는 언어이다.'
}
function showjs() {
